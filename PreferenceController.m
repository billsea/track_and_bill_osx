...
- (void)windowDidLoad {
  ...
  [lblPrefsAddress
      setStringValue:NSLocalizedString(@"PrefsAddress", @"PrefsAddress")];
  [lblPrefsCity setStringValue:NSLocalizedString(@"PrefsCity", @"PrefsCity")];
  [lblPrefsState
      setStringValue:NSLocalizedString(@"PrefsState", @"PrefsState")];
  [lblPrefsPostal
      setStringValue:NSLocalizedString(@"PrefsPostal", @"PrefsPostal")];
  [lblPrefsPhone
      setStringValue:NSLocalizedString(@"PrefsPhone", @"PrefsPhone")];
  [lblPrefsEmail
      setStringValue:NSLocalizedString(@"PrefsEmail", @"PrefsEmail")];
  [lblPrefsContact
      setStringValue:NSLocalizedString(@"PrefsContact", @"PrefsContact")];
  [prefsSaveButton
      setTitle:NSLocalizedString(@"prefsSaveButton", @"prefsSaveButton")];
  [prefsCloseButton
      setTitle:NSLocalizedString(@"prefsCloseButton", @"prefsCloseButton")];
...
- (void)saveDataToDisk {
  ...
  err = NSRunAlertPanel(NSLocalizedString(@"selSettings", @"selSettings"),
                        NSLocalizedString(@"selSetSave", @"selSetSave"), @"sOK",
                        nil, nil);
}
  ...
  if (arrProfiles != newProfiles) {
    ...
    if ([arrProfiles count] > 0) {
      ...
      if ([[arrProfiles objectAtIndex:0] profileAddress] != nil) {
        [txtMyAddress
            setStringValue:[[arrProfiles objectAtIndex:0] profileAddress]];
      }
      ...
      if ([[arrProfiles objectAtIndex:0] profileState] != nil) {
        [txtMyState
            setStringValue:[[arrProfiles objectAtIndex:0] profileState]];
      }
      ...
      if ([[arrProfiles objectAtIndex:0] profilePhone] != nil) {
        [txtMyPhone
            setStringValue:[[arrProfiles objectAtIndex:0] profilePhone]];
      }
      if ([[arrProfiles objectAtIndex:0] profileEmail] != nil) {
        [txtMyEmail
            setStringValue:[[arrProfiles objectAtIndex:0] profileEmail]];
      }
      if ([[arrProfiles objectAtIndex:0] profileContact] != nil) {
        [txtMyContact
            setStringValue:[[arrProfiles objectAtIndex:0] profileContact]];
      }
    }
  }
}
...
- (void)writeSettings:(NSString *)plistKey:(NSString *)plistValue {
  ...
  [settingsDict writeToFile:settingsPath
                 atomically:nil]; // write back to plist file
...
- (void)loadSettings {
  ...
  //[dateFormat selectCellWithTag:[[settingsDict objectForKey:@"dateFormat"]
  //intValue]];
